            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                Registrando a una nueva moneda
                            </div>
                        </div>
                        <div class="card mb-4">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12" >
                                                <div class="form-group">
                                                    ...
                                                    type="text" placeholder="Nombre de la Moneda" title="Ingrese el nombre de la moneda" required/>
                                                    <input type="hidden" id="txtaccion" name="txtaccion" value="1"/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="small mb-1" >Símbolo: </label>
